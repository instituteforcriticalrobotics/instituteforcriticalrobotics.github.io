...
3. There could be an alternative that can detect very short distance (the closest is 2 cm) - Ultrasonic Module HC-SR04 Distance Sensor For Arduino, cost 15 dirhams

5. However, our robot is quite large so the precision of 20 cm should be fine?
